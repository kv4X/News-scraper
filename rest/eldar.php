...
/* GENERAL */
define("APP_NAME", "SVAKIDAN AUTOMATIK");

/* DATABASE */
define("DB_SERVER", "localhost");
define("DB_DATABASE", "scraper2");
define("DB_USERNAME", "root");
define("DB_PASSWORD", "svakidan1231");

/* Classes Autoloader */
function autoload($class){
	// classes dir 
	$dir = "/var/www/svakidan/almir/api/classes/";
...
require_once "/var/www/svakidan/almir/api/classes/scraperPost.php";
$db = new Db(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
$wp = new Wp("http://195.201.22.238/socni-xmlrpc.php", "admin", "bosanski123123");
